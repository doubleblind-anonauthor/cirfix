...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _3234_archive_1.so
_3234_archive_1.so : archive.90/_3234_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -o .//../simv.daidir//_3234_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_3234_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.90/_prev_archive_1.a
	@$(AR) -s $<
